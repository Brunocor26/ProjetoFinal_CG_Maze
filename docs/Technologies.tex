...
Para a comunicação em rede entre o host e o cliente, o projeto utiliza \textbf{sockets TCP} POSIX. Esta escolha permite comunicação fiável entre processos através de uma interface de programação padrão disponível em sistemas Unix-like.
